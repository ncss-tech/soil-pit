...
get_sdjr_NASIS_db <- function(selected_set = TRUE) {
  ...
  q <- paste("SELECT p.uprojectid, p.projectname, a2.areasymbol, lmu.lmapunitiid AS mukey, lmu.musym, mu.nationalmusym, muacres
  ...
  WHERE 
      ...
      p.projectname LIKE 'SDJR%' AND 
      p.uprojectid LIKE '2016%' AND 
