...
get_NASIS_db <- function() {
  ...
  q <- "SELECT lmapunitiid, muacres, areasymbol
  
  FROM lmapunit_View_1 lmu
  
  INNER JOIN legend ON legend.liid = lmu.liidref
...
component <- read.csv("C:/workspace/component.csv")
...
# save output
write.csv(component_max, file = "C:/workspace/component_max.csv")
```