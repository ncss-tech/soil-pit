...
source("C:/Users/Stephen/SkyDrive/R/gis/rsagaFunctions.R")
```
...
state <- c("IA", "IL", "IN", "KS", "KY", "MI", "MN", "MO", "NE", "OH", "OK", "SD", "WI")
nhdgdb <- paste("E:/geodata/hydrography/NHDH_", state, ".gdb", sep="")

# Generater raster names
dem10 <- paste(sdat.p, "ned10m_11", office.l, ".sgrd", sep="")
dem30 <- paste(sdat.p, "ned30m_11", office.l, ".sgrd", sep="")
radiusD <- 2
...
dem10.tif <- paste(pd.p, office.l, "/ned10m_11", office.l, ".tif", sep="")
...
t.l <- c("wetness", "z2stream", "mvalleys")
...
batchWarp(n30.l, n10.l, nlcd.p, 10, "cubicspline", crsarg, crsarg, "Float32", "-32768", co)
