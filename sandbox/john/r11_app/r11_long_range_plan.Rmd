...
kable(a_wide2, align = "r", caption = "Long Range Plan Summarized by Acreage of Projects", format="html") %>% kable_styling(bootstrap_options=c("striped", "hover"))
...
kable(a_wide1, align = "r", caption = "Long Range Plan Summarized by Total Number (n) of Projects", format="html") %>% kable_styling(bootstrap_options=c("striped", "hover"))
