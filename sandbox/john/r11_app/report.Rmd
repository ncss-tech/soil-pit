...
print(kable(pm[1, 1:3], "html") %>% kable_styling(bootstrap_options=c("striped", "hover")))

print(kable(pm[4:ncol(pm)], "html") %>% kable_styling(bootstrap_options=c("striped", "hover")))
...
print(kable(with(s, data.frame(dmudesc_short, compname, taxpartsize, pmgroupname)), "html") %>% kable_styling(bootstrap_options=c("striped", "hover", "responsive")))
# , landform.string)))
```
