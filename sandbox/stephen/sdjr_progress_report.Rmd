...
names(test3) <- c("Fiscal Year", "Affected Acres", "Top 5 Soil Series Affected")
kable(test3, align = "l")
...
spplot(fy_r, sp.layout = ssa_sub, maxpixels = 500, xlim = -1e4+bbox(ssa_sub)[1, ], ylim = -1e4+bbox(ssa_sub)[2, ], colorkey = FALSE, col.regions = "blue", strip = strip.custom(bg = grey(0.85)), main = "Time series of SDJR Progress", fontsize = 12)
