...
SS_Office <- "11-WAV"
fy <- 2015
mupolygon <- read.dbf("M:/geodata/project_data/11WAV/mupolygon_edits.dbf", as.is = TRUE)
...
outside <- subset(outside, Region != 11 & match == FALSE, select = c("Region", "AREASYMBOL", "musym", "old_musym", "n_polygons", "acres", "pname", "key", "in_legend"))
kable(outside, caption = "MUSYM that need updating outside of Region 11")
