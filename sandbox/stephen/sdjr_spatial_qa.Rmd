...
fy <- 2015
R_Office <- 10
mupolygon <- read.dbf("L:/geodata/project_data/11WAV/mupolygon_edits_from_Region10.dbf", as.is = TRUE)
...
leg <- read.csv("C:/workspace/fy15_qa_spatial/report_legends_2015_09_03.csv")
...
corr_r <- subset(corr, grepl(SS_Office, Office))
