...
region <- 11
office <- c("11-ATL")
mupolygon <- read.dbf("M:/geodata/project_data/11ATL/11ATL_mupolygon_edits_fy16_v3.dbf", as.is = TRUE)
...
goals <- read.csv("C:/workspace/report_goals_fy16_2016_09_09.csv")

# corr <- sdjr_correlation(asymbol, project_id, start_date, finish_date)
corr <- read.csv("C:/workspace/report_correlation_fy2016_AK%25_WY%25_2016_09_09.csv")

# legend <- legends_report(st)
legends <- read.csv("C:/workspace/report_legends_2016_09_09.csv")
```
...
goals_sub <- goals[goals$ss_office %in% office, ]
