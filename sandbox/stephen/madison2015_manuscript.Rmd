...
The resulting field and lab pedon reports contain much of the same information typically used to summarize data for developing OSD and aggregated mapunit soil components, and competing dissimilar soils.

```{r, echo=FALSE, warning=FALSE, comment=""}
load("miami_field.RData")
load("miami_lab.RData")

cols <- brewer.pal(n = length(levels(miami_field$genhz)), name = "Paired") 
...
* Find some where to cite Fred Young 
