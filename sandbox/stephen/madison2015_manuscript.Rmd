...
qplot(genhz, value, data = h.lo, geom = "boxplot", xlab = "Generalized Horizon Label", main = "Boxplot of Miami field pedons by generic horizon") + facet_wrap(~variable, scales = "free") + theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))

qplot(genhz, value, data = lh.lo, geom = "boxplot", xlab = "Generalized Horizon Label", main = "Boxplot of Miami lab pedons by generic horizon") + facet_wrap(~variable, scales = "free", ncol = 4) + theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))
