...
Evaluating the graphics and tables within the report quickly shows where there are possible errors, narrow or wide ranges in values or data gaps due to insufficient data.
...
Rarely can soil scientists observe full pedons or polypedons, due to the limitations of human observations. Therefore we can only approximate their internal variability by examining several soil profiles and comparing their descriptions.
