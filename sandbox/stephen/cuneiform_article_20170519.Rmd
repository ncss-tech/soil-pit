...
Hopefully folks familiar with R will find the new `r fetchSDA_component()' soilDB R function(s) useful for importing soil data from SDA. For those that aren't R literate, have no fear, see John Hammerly's article on plotting water table data using a Web App. One of the nice features of R, is that it can also be used to create Web Apps for the general public. So in the near future, please vist the Region 11 website learn to Soils with our custom Web Apps.