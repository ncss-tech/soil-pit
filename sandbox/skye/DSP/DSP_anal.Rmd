...
dsp_pr <- which(dsp$Name==PROJECT)
naClean <- Filter( f=function(x) !all(is.na(x)), x=naDirty)

#see number of observations for all Bulk Density methods
table(dsp_pr[, grep("^BD", names(dsp_pr))])
