...
# rs %>%
#   filter(Master %in% c('A','E','B','C')) %>%
#   ggplot(aes(y = BD, x =SOC)) + geom_hex(fill = ..density.., color = "black") +
#   scale_colour_gradientn(colours=rainbox(7))
...
ggplot(rs, aes(y = BD, x = Master)) + geom_jitter(aes(color = SOC), alpha = .5) +
  scale_color_gradientn(colours = cet_pal(3, name = "diverging_bwr_40-95_c42_n256"))
...
rs %>%
  filter(Master %in% c('A','E','B','C')) %>%
  ggplot(aes(y = BD, x = Master)) + geom_jitter(aes(color = SOC)) +
  scale_colour_gradientn(colours = cet_pal(3, name = "diverging-rainbow_bgymr_45-85_c67_n256"))
,
rs %>%
  filter(Master %in% c('A','E','B','C')) %>%
  ggplot(aes(y = BD, x = Master)) + geom_jitter(aes(color = SOC)) +
  scale_colour_gradientn(colours = cet_pal(5, name = "diverging-rainbow_bgymr_45-85_c67_n256"))
,
rs %>%
  filter(Master %in% c('A','E','B','C')) %>%
  ggplot(aes(y = BD, x = Master)) + geom_jitter(aes(color = SOC)) +
  scale_colour_gradientn(colours = cet_pal(5, name = "diverging_cwm_80-100_c22_n256"))
,
rs %>%
  filter(Master %in% c('A','E','B','C')) %>%
  ggplot(aes(y = BD, x = Master)) + geom_jitter(aes(color = SOC)) +
  scale_colour_gradientn(colours = cet_pal(20, name = "diverging-linear_bjr_30-55_c53_n256"))
,
nrow=2,ncol=2)
#########
