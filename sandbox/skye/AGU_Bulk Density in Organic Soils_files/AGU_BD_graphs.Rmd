...
Den2O <- combo %>%
 ...
 ggplot(sata= DD2, aes(y=SD, x =D)) +     geom_jitter(color = "lightblue", size =4, alpha = 0.75) + 
  ...
  theme(plot.caption=element_text(hjust=0,size=9),
        ...
        plot.title=element_text(size=24))+
#labs(x="Bulk Density",y="Dataset",caption="@wills_skye", title = ' Carbon Density of all horizons)
 labs(x =expression(paste('SOC Density (g cm'^-3,')')), y='Depth Class (cm)', color = 'Master Horizon', title = 'Organic horizons (field Described)') +
  facet_wrap(~SET)
...
Den2Oc <- combo %>%
 ...
 ggplot(sata= DD2, aes(y=SD, x =D)) +     geom_jitter(aes(color = SOCm), size =4, alpha = 0.95) + 
  ...
  theme(plot.caption=element_text(hjust=0,size=9),
        ...
        plot.title=element_text(size=24))+
#labs(x="Bulk Density",y="Dataset",caption="@wills_skye", title = ' Carbon Density of all horizons)
 labs(x =expression(paste('SOC Density (g cm'^-3,')')), y='Depth Class (cm)', color = '% SOC', title = 'Organic horizons, field described') +
  facet_wrap(~SET)

Den2Oc
>>>>>>> 4d895d5ffb132f55fefaf5b640e03e55be3eaaa7
