...
map('county', 'indiana,marion', add=T, fill = T, col="purple") #add Pulaski County, Indiana in purple to map
map.text("county", "indiana,Marion", add=T) #add text for Pulaski

#read all the csv files from a folder as one table
datalogger=ldply(list.files(path="E:/geodata/project_data/11IND//IPO_Data_Loggers/data_loggers_2017/brookston_51_2_ECP_Marion_IN",pattern="csv",full.names=TRUE),function(filename) {
...
datalogger$convin <- (31-datalogger$inches) #inches -
