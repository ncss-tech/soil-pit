...
if (!all(is.na(s$aspect_field))) {
  ...
  kable(rbind(morf.5n, aspect.5n), caption = "Elevation, slope gradient and aspect (min, 25th, median, 75th, max)(n)")
} else(kable(morf.5n, caption="Elevation and slope gradient (min, 25th, median, 75th, max)(n)")
)         
