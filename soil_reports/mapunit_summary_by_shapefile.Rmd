...
shp <- "SDJR - MLRA 114A - Cincinnati silt loam, 6 to 12 percent slopes, eroded"

dir <- "D:/geodata/project_data/"
...
if (!file.exists(cache)){
  ...
  n <- round(sum(data.frame(mupolygon)$SHAPE_Area) / 900 * samplePercent / 100, 0)
