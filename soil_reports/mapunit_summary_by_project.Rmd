...
project <- c("SDJR - MLRA 111D - Miami-Crosby silt loams, 2 to 6 percent slopes") # name of project
...
cache_shp <- paste0(pd, "cache/", shp, ".shp")
...
if (!file.exists(cache)){
   ogr2ogr(
     ...
     where = paste0("PROJECT_NAME IN (", noquote(paste0("'", project, "'", collapse=",")),")"),
  ...
  n <- round(sum(mupolygon@data[, grepl("_area", tolower(names(mupolygon)))]) / 900 * samplePercent / 100, 0)
