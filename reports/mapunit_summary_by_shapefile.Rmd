...
shp <- "M:/geodata/project_data/11JUE/cache/201711JUE024_Plfsndlsbstr6t12ps_QA.shp"

geodatabase <- "M:/geodata/project_data/11JUE/RTSD_R11-JUE_FY16.gdb"
...
if (!file.exists(cache)){
  ...
  mupolygon.s <- {sapply(slot(mupolygon, 'polygons'), function(x)
    spsample(x,
