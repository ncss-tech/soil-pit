...
hc.c <- cast(hc.cs, hzname ~ variable, value='range')
hc.cm <- merge(hc.c, data.n, by="hzname")

print(xtable(hp.cm))
print(xtable(hc.cm))

# Box plots of numeric variables by generic horizon
bwplot(hzname ~ value|variable, data=rbind(hp.m, hc.m, thk.m), scales=list(x="free"))          
