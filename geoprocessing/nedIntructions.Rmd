...
install.packages(c("gdalUtils", "foreign", "rgdal", "raster"))
library(gdalUtils)
library(foreign)
library(rgdal)
library(raster)
...
```{r, eval=FALSE}
# Set parameters
source("C:/Users/stephen.roecker/Documents/soil-pit/trunk/geoprocessing/nedFunctions.R")
source("C:/Users/stephen.roecker/Documents/soil-pit/trunk/geoprocessing/gdalUtilsFunctions.R")
tile.p <- "M:/geodata/elevation/ned/tiles/img/"
office.l <- c("8VIC")
pd.p <- "M:/geodata/project_data/"
geodatabase <- paste("M:/geodata/project_data/8VIC/FG795_OFFICIAL.gdb")
...
dst.p <- paste(pd.p, office.l, "/ned09d_11", office.l, ".tif", sep="")

mosaicList(mo.l, dst.p, "Float32", c("COMPRESS=DEFLATE", "TILED=YES", "BIGTIFF=YES"), -99999)
```
