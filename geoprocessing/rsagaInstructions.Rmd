...
source("C:/Users/stephen.roecker/Documents/soil-pit/trunk/geoprocessing/rsagaFunctions.R")
```
...
```{r, eval=FALSE}
setwd("C:/geodata/project_data")
pd.p <- "C:/geodata/project_data/"
office.l <- c("8VIC")
sdat.p <- paste(pd.p, office.l, "/sdat/", sep="")
state <- c("NV", "CA")
nhdgdb <- paste("M:/geodata/hydrography/NHDH_", state, ".gdb", sep="")
