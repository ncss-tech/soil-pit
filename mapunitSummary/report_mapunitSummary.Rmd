...
mukey <- c("678706", "160790", "160791") # List of mukey
...
mapunit.summary<-function(musym,samplePercent){
  ...
  if(ifelse(file.exists("mu678706.160790.160791.shp"), TRUE, FALSE))
    function(){
    ogr2ogr(
    ...
    save(data, file=paste0(shp, "_", samplePercent, ".sample.Rdata"))
  return(list(data=data, mupolygon=mupolygon, sapolygon=sapolygon))
  } else load(file=paste0(shp, "_", samplePercent, ".sample.Rdata"))
}
...
bwplot(MUKEY ~ value|variable*AREASYMBOL, data=pol.as.m, scales=list(x="free"))
```
