...
fname <- paste0(ownCloud, "lims_goal_", "2017-12-17_us_2012_2017", ".csv")
...
fname <- paste0(ownCloud, "lims_project_", "2017-12-17_us_2012_2017", ".csv")
...
fname <- paste0(ownCloud, "lims_reverse_correlation_fy_", "2017-12-17_us_2012_2017.csv")
...
rcor_as$acres <- cut(rcor_as$muacres, 
                     breaks = c(0, 10000, 50000, 100000, 150000, 500000, 1000000), 
                     labels = c("0-10k", "10-50k", "50-100k", "100-150k", "150-500k", "500k-1000k")
                     )
...
png(file = "acres_gg.png", width = 17, height = 11, units = "in", res = 400)
plot(acres_gg)
dev.off()
