...
fname <- paste0(ownCloud, "lims_goal_", "2017-12-16", ".csv")
...
fname <- paste0(ownCloud, "lims_project_", "2017-12-16", ".csv")
...
fname <- paste0(ownCloud, "lims_reverse_correlation_fy_", "2017-12-16.csv")
...
rcor_as$acres <- cut(rcor_as$muacres, 
                     breaks = c(0, 10000, 50000, 100000, 150000, 500000), 
                     labels = c("0 - 10,000", "10,000 - 50,000", "50,000 - 100,000", "100,000 - 150,000", "150,000 - 500,000")
                     )
...
# ggplot2 (require github version)
