...
mupolygon$idx <- row.names(mupolygon)
...
dd <- c(elev   = "ned10m_11FIN.tif",
        aspect5 = "ned10m_11FIN_aspect5.tif",
        slope5  = "ned10m_11FIN_slope5.tif",
        ss      = "ned10m_11FIN_slopeshape.tif",
        mvalley = "ned30m_11FIN_mvalleys.tif",
        wetness2  = "ned30m_11FIN_wetness.tif",
        z2streams = "ned30m_11FIN_z2stream.tif",
        lulc    = "nlcd30m_11FIN_lulc2011.tif"
        )
...
group_by(test, nationalmusym, erocl_50plus) %>% 
  summarize(n = length(erocl_50plus), 
