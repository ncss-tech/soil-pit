...
region <- 11
office <- c("11-JUE")
mupolygon <- foreign::read.dbf("C:/Users/stephen.roecker/ownCloud/r11_jue_spatial.dbf", as.is = TRUE)
...
corr <- read.csv(paste0(ownCloud, "lims_correlation_fy2017_IA%25_WI%25_2017_09_07.csv"))

# legend <- legends_report("mi%25")
legends <- read.csv(paste0(ownCloud, "report_legends_2017_09_07.csv"))
```
