...
ownCloud <- "C:/Users/stephen.roecker/ownCloud/Documents/lims_data/"

fy <- 2017
region <- 11
office <- c("11-CLI")
mupolygon <- read.dbf("C:/workspace/mi125_test.dbf", as.is = TRUE)
...
goals <- read.csv(paste0(ownCloud, "lims_goals_fy16_2016_12_13.csv"))

# corr <- sdjr_correlation(asymbol, project_id, start_date, finish_date)
corr <- read.csv(paste0(ownCloud, "lims_correlation_fy2016_AK%25_WY%25_2016_09_19.csv"))

# legend <- legends_report("mi%25")
legends <- read.csv(paste0(ownCloud, "lims_legends_2016_09_09.csv"))
```
...
mupolygon_edits <- subset(mupolygon, (musym != new_musym & musym != "") | editor != "")
