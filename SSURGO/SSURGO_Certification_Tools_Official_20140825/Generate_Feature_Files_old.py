        ...
        with open(txtSPFT, 'r') as chkTXT:
            ...
            for line in lines:
                ...
                if line.count('"') <> 10:
                    ...
                    PrintMsg( '\nIncorrect length for FEATSYM on line ' + str(countLine) + ' in ' + txtSPFT, 2)
                    totalError = totalError + 1
...
def fileUpdater(txtSPFT):
    ...
    try:
        ...
        #PrintMsg(' \nCreating the file ' + outLoc.upper()  + 'FEATURES.TXT\n', 1)
            ...
            PrintMsg("Failed at " + str(txtSPFT))
            return False, noPtLst, withDefLst, noDefLst
