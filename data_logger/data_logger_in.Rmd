...
datalogger=ldply(list.files(path="E:/geodata/project_data/11IND//IPO_Data_Loggers/data_loggers_2017/kokomo_49_Madison_OH",pattern="csv",full.names=TRUE),function(filename) {
