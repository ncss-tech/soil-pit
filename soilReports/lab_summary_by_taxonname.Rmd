...
l.h$hzname[is.na(l.h$hzname)] <- h$hznameoriginal

l.h$hzname[is.na(l.h$hzname)] <- "NA"
l.h$genhz <- generalize.hz(l.h$hzname, ghr[[series]]$n, ghr[[series]]$p)
...
# Summarize site data
s.sub <- subset(l.s, select=c("psctopdepth", "pscbotdepth", "noncarbclaywtavg", "claytotwtavg", "le0to100", "wf0175wtavgpsc", "volfractgt2wtavg", "cec7clayratiowtavg"))
s.m <- melt(s.sub, measure.vars=c("psctopdepth", "pscbotdepth", "noncarbclaywtavg", "claytotwtavg", "le0to100", "wf0175wtavgpsc", "volfractgt2wtavg", "cec7clayratiowtavg"))
