...
mukey <- c('2518174','2518177','2567836','2567834','2567840','2567851','2567854','2567856','2567860','2567864','2567866','2567874','2567878','2567880','2569641','2569642','2569645','2569649','2569651','2569653','2569655','2569658','2569660','2569662','2569663','2569667','2569670','2569674','2569675','2569678','2569684','2569688','2569690') # List of mukey
dir <- "I:/Stephens_files/geodata/project_data/"
geodatabase <- "RTSD_Region_11_FIN_FY15.gdb"
office <- "11FIN"
...
shp <- paste("mukey", noquote(paste(mukey[c(1, length(mukey))], collapse=".", sep="")), sep="")
...
mapunit.summary<-function(mukey, samplePercent){
  # Import geodatabase
  if(ifelse(file.exists(paste0(cache, ".Rdata")), "NA", 1) == 1) {
   ogr2ogr(
...
pol$SSA_MUSYM_MUKEY <- as.character(paste(pol$AREASYMBOL, pol$MUSYM, pol$MUKEY))
pol.m <- melt(pol, id.vars="SSA_MUSYM_MUKEY", measure.vars=c("Acres", "Circularity"))
...
Circularity is a meature of shape complexity (Hole and Campbell, 1975), computed as mupolygon length / mupolygon circumference, with 1 being equal to a percent circle.

```{r bwplot of polygon metrics, echo=FALSE}
bwplot(SSA_MUSYM_MUKEY ~ value|variable, data=pol.m, scales=list(x="free"))
```
