...
s$hillslope_pos <- as.character(s$hillslope_pos)
...
if (all(!is.na(diag.lo$value))) {
  bwplot(diag_kind ~ value|variable, data = diag.lo, scales = list(x = "free"), xlab = "cm")} else("no diagnostic horizons have been populated")          
```
