...
data2$SSA_MUSYM_MUKEY <- "representative"
...
print(xtable(prop.table(xtabs(~SSA_MUSYM_MUKEY+valleysBreaks,data=data), margin=1)*100, digits=0, caption="Upland vs. lowland"), type="html", caption.placement="top")
```
...
data.m <- melt(data, id.vars="SSA_MUSYM_MUKEY", measure.vars=c("elev", "slope", "valleys", "wetness", "relief", "ppt", "temp", "ffd"))
