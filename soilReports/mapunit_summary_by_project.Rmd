...
print(xtable(prop.table(xtabs(~SSA_MUSYM+lulcBreaks,data=data), margin=1)*100, align=rep("c", 1+length(levels(data$lulcBreaks))), digits=0, caption="Landuse and Landcover"), type="html", caption.placement="top")
```
...
print(xtable(merge(data.cs.c, data.n, by="SSA_MUSYM"), align=rep("c", 2+ncol(data.cs.c))), type="html")
