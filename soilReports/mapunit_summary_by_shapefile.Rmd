...
shp <- "SDJR-MLRA111A-Crsby-Lslm,0t2ps"
...
## local functions
if (!file.exists(paste0(cache, "_", samplePercent, ".Rdata"))){
  ...
  save(data.l, file=paste0(cache, "_", samplePercent, ".Rdata"))
} else load(file = paste0(cache, "_", samplePercent, ".Rdata")) #load cache file
