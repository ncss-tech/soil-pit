...
# project_id <- "%25"
# years <- 2012:2017; start_date <- paste0("10/01/", years - 1); finish_date <- paste0("10/01/", years)
# 
...
rcors17 <- read.csv("lims_correlation_fy2017_al%25_wy%25_2017_03_20.csv")
